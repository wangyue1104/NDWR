一、简介
=================
一个类似于Java DWR（Direct Web Remoting） 的.net简单实现版本。

关于Java DWR 的说明，可以参照http://directwebremoting.org/dwr/index.html
...
* 2.不要尝试在ndwr传参中注入自定义参数名，这样可能会导致解析歧义
	
* 3.方法名不要使用FuncSwitch
	
* 4.服务名不能重名，方法名一样
	
* 5.公开方法参数不接受null值，如果有null需求，可把参数放入实体中